...
(function() {
  ...
  root.getPlayer = function() {
    ...
    */
    ...
    if ((_ref1 = root.currentPlayer) == null) {
      root.currentPlayer = {
        id: +(new Date()),
        currentGame: '',
        first: '',
  ...
  root.loadJSONConfigs = function() {
    ...
    */
    ...
    root.readJSON('config/config.json', function(data) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        type = _ref[_i];
        root.readJSON("config/" + type + ".json", function(typeData) {
          if (typeData === void 0) {
            if (typeof console !== "undefined" && console !== null) {
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        quest = _ref1[_j];
        root.readJSON("config/" + quest + ".json", function(questData) {
      ...
      root.readJSON("config/" + data.graders, function(graderData) {
        var grader, graderIndex, _k, _len2, _ref2, _results;

        if (graderData === void 0) {
          if (typeof console !== "undefined" && console !== null) {
            console.log("Grader Data Undefined");
          }
          configFail = true;
        }
        if (root.graders == null) {
          root.graders = [];
        }
        graderIndex = -1;
        _ref2 = graderData.graders;
        _results = [];
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          grader = _ref2[_k];
          ++graderIndex;
          _results.push(root.graders[graderIndex] = grader);
        }
        return _results;
      });
